...
//1--)agar my kisi variable ko globally define karo ga to usy function ky andar bhe or bahar bhe kahen bhe use/call kar skta hon magar 
// agar my kisi variable ko locally yani sirf function ky andar use karta hon to usy my sirf function sy bahar hi call kar skta hon
...
// }
// tellTime();
//  agar my kisi variable ko globally define karo ga to usy function ky andar bhe or bahar bhe kahen bhe use kar skta hon magar agar my
// kisi function ko locally yani sirf function ky andar use karta hon to usy my sirf function sy bahar hi call kar skta hon
// Q2;
...
// Ans: Yes, Due to Hoisting whenever a function is declared or a variable is declared with var keyward they will go to the top of the
// code that it why it is not necessary to invoke (call) a function only after the function declartion/ function defination   
...
// Ans: Default parameter sirf usy time use my aty han jab function invoking ky time ham arguments my value pass nae karty to jo value 
// ham ny parameter my pass ki hoti hy woh execute hojati hy
...
// NOTE>>>> If we have created 1 Arrow function with SUM name then we cannot create another function with same (SUM) name BEACAUSE we are
// using let and const AND they both cannot be redeclacred 
...
// document.querySelector("#stop-timer").addEventListener("click",function(){ // function() ya anonyums function hy iss ki jagah ham 
// arrow function use kr skty han or yahaan par yah as a callback function use ho raha hy addeventlistner ky HOF ky sath 
...
// Why we use IIFE 
// ANS: Yah ab use nae hota han lekin legacy (old) code my kahen use ho raha hota hy yah use isi liye kia jata tha ky agar jab kisi 
// varaible ko window object my space occupy karey begahir use karna chaiheyee taa ky woh window object my naa chala gy tab ham uss 
// variable ko IIFE my use karty thy kiu ky agar hamary pas multiple files hoti han project ky time hosta hy ky jis name sy ham 
// varibale declare karen woh already kahen kis or file my use ho raha ho or uss ki wjah sy error aa gy kiu ky multiple files hon magar
// un ka window object aik hi hota hy to ham agar chahty han yah issue create na hon isi wjah sy ham IIFE use karty thy 
