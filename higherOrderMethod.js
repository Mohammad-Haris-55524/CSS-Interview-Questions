...
// }  
// const fruits = ["Banana", "Orange", "Apple", "Mango", "haris", "zain", "ali"];
// console.log(fruits.splice(1,4)) // 1 sy start karo 4 delete kar do 
// console.log(fruits.splice(5,1)) // 1 sy start karo 4 delete kar do 
// // const newArr = fruits.slice(1,4) //["orange " "Apple", "Mango"]
// console.log(fruits) //['Banana', 'zain', 'ali']
// console.log(newArr) //["orange " "Apple", "Mango"]
...
// ******findIndex(Same as SOME() method)==>Index no return karta hy jahaan condition true hogi true hoti hi ruk gy ga agar koi condition 
// true nae hogi to -1 index no dy ga
...
const fruits = "haris mera name hay";
const entriesArray = Array.from(fruits);
...
const obj = {
  ...
  console.log("Hobies array:", hobbiesArray);
