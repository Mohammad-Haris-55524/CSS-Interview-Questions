...
//     //Get Current position: It is a higher order function that takes 2 callbacks 1st (sucess callback: This call back will run
//  only when it is sucessfull in getting postion it provides us an object of GeolocationPosition that contains the coordinates and by accesing
//  cordinates we can acheive latitude and longitute becuase  coordinates contains an object of values of latitude and longitude) and the
// 2nd callback is the failure callback that works only when there is an eroor while fetching location.
...
address: {street: 3, area: "Golden Town", city: "Karachi", "THIS keyward": this}, //"THIS keyward": this ==> Here this will global object
//  known as window object.
// greeting: () => {console.log("THIS: ", this);} // In an arraow function this keyward will refer as a global object known as window
//  object.
// *****************************************************THIS KEYWARD AS A OBJECT *********************************************************
        ...
        // 'use strict'; Will not work here due to function keyward beacuse it is hoisted. Agar strict mode lagana hi hay to top of the 
        // code on line # 01 par lagana pary ga.
        // **************3) In a function, this refers to the global object.*************************
        const functionThis = function(){  // this is a function expression function expression ko bhe normal function ki trha call karna 
        // parta hay
        // yahaan my function expression isi liye bana raha hon kiu ky yah anonyums function hay or iss ki value kisi my to save karani 
        // pary gi isi
        // liye yah function expression bana kar varible my save kara di. Ham chahty to function name dy kar bhe yah kaam kara skty han 
        // koi issue
        // nae.
    ...
    //   What if we will create a function by using function keyward it will bind 'THIS' to an object an will sove the NaN error beacuse 
    // here 'THIS'
...
//             // } 
//             check(){
//                 const anotherFunc = ()=>console.log(this.userName ,"&", this.name)
//                 anotherFunc()
//             } 
//         }
// }
